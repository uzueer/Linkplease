# LinkPlease — Automated Instagram DM Service

A resilient, event-driven microservice built to automate Instagram Direct Messages (DMs) for creators based on comment keyword triggers.
